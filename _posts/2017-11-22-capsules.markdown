...
I have written a simple Tensorflow implementation of the MNIST capsule network as described in CapsNet17, located at my [GitHub](https://github.com/leiz86/capsules-network). 
...
Finally, since capsules learn a different type of representation as CNNs and are more robust to certain affine transformations, are they more robust to adversarial examples? Some [early experiments](https://github.com/InnerPeace-Wu/CapsNet-tensorflow) appears to answer in the negative.
